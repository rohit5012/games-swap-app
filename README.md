...
<img width="232" alt="Screenshot 2024-02-15 at 04 11 45" src="https://github.com/user-attachments/assets/416c17dc-343f-41eb-afd9-8fd140d5fe2b">
  ...
  <p align="center">
    ...
    ·
    <a href="https://github.com/Smasheroonie/game-swap-fe/issues">Request Feature</a>
  </p>
</p>
...
<img width="1398" alt="Image" src="https://github.com/user-attachments/assets/b02fe72e-879c-460f-a741-88280fd31e4a" />
<img width="1405" alt="Image" src="https://github.com/user-attachments/assets/55b63b6a-adfc-4409-8a40-dd3ed1be7882" />
...
```shell
git clone github.com/Smasheroonie/game-swap-fe.git
cd project
```
...
See the [open issues](https://github.com/Smasheroonie/game-swap-fe/issues) for a list of proposed features (and known issues).
...
6. rawg.API(https://rawg.io/apidocs)
...
You can contact us by opening an issue in this [repo](https://github.com/Smasheroonie/game-swap-fe/issues). We will get back to you as soon as we can.

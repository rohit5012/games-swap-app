...
export default function Footer() {
  return (
    <section className="w-full py-12 md:py-10 lg:py-10 bg-zinc-900 dark:bg-zinc-100 flex justify-center">
      <div className="container px-4 md:px-6 flex flex-col items-center justify-center text-center">
        ...
        <div className="flex justify-center space-x-4">
          <Link
            ...
            prefetch={false}
          >
            <FacebookIcon className="h-6 w-6 hover:animate-rotate" />
          </Link>
          <Link
            href="#"
            ...
            prefetch={false}
          >
            <TwitterIcon className="h-6 w-6 hover:animate-rotate" />
          </Link>
          <Link
            href="#"
            ...
            prefetch={false}
          >
            <InstagramIcon className="h-6 w-6 hover:animate-rotate" />
          </Link>
          <Link
            href="#"
            ...
            prefetch={false}
          >
            <LinkedinIcon className="h-6 w-6 hover:animate-rotate" />
          </Link>
        </div>
      </div>
    </section>

...
const ProfilePage: React.FC = () => (
  ...
  <div className="flex flex-col items-center container mx-auto px-2  ">
    ...
    <div className="text-lg text-gray-800 mb-4 bg-gray-100 p-8 rounded-lg shadow-lg w-full max-w-4xl mx-auto my-8">
      <p className="w-full">
        Meet our exceptional team of web developers—Javier, Luke, Rohit, Liliia
        and Nadim. They bring expertise in front-end and back-end technologies
        like React, Typescript, Node.js, Firebase, Javascript and Netify. Beyond
        their technical prowess, they are known for their friendly and
        supportive nature. Javier, the front-end wizard, simplifies complex
        concepts with her approachable demeanor. Rohit and Luke, the full-stack
        expert, excels in collaborative troubleshooting. Nadim and Liliia, the
        Backend specialist, contributes bright ideas with a positive attitude.
        Together, they create a dynamic, supportive, and innovative environment,
        making them not just skilled professionals but also amazing colleagues.
      </p>
    </div>

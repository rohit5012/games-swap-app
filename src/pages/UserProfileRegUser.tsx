    ...
    <div className="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden transition-colors duration-200 mt-12">
      ...
      <div className="relative pt-16 px-6 pb-6 flex flex-col md:flex-row gap-6">
        ...
        <div className="flex flex-col text-gray-600 dark:text-gray-300 flex-1">
          ...
          {isEditing && (
            <div className="mt-6">
              <h3 className="font-semibold text-gray-900 dark:text-white">Select Platforms</h3>
              <div className="flex space-x-4 mt-2">
                <div>
                  ...
                  />
                  <label htmlFor="xbox" className="ml-2 text-gray-600 dark:text-gray-300">
                    Xbox Series X/S
                  </label>
                </div>
                <div>
                  ...
                  />
                  <label htmlFor="playstation" className="ml-2 text-gray-600 dark:text-gray-300">
                    PlayStation 5
                  </label>
                </div>
                <div>
                  ...
                  />
                  <label htmlFor="switch" className="ml-2 text-gray-600 dark:text-gray-300">
                    Switch
                  </label>
                </div>
              </div>
